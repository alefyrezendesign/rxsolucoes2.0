...
const HomePartners = () => {
    ...
    return (
        <section className="relative w-full text-white pt-10 pb-24 md:py-32 z-10">
            ...
            <div className="absolute top-[-320px] md:top-[-460px] left-0 right-0 w-full h-[120%] md:h-[150%] z-0 pointer-events-none">
            ...
            <div className="w-full max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                ...
                {/* Blocos de Ação */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 w-full max-w-5xl mx-auto mb-20">
                    ...
                    <motion.div
                        ...
                        className="bg-black/40 backdrop-blur-sm border-[3px] border-white/10 rounded-none p-5 md:p-6 flex flex-col items-center text-center hover:bg-black/60 hover:border-primary-500/40 transition-all duration-300 relative overflow-hidden group"
                    >
                        ...
                        <div className="w-12 h-12 rounded-full bg-primary-500/10 flex items-center justify-center mb-3 md:mb-4 relative z-10 shrink-0">
                            <MessageCircle className="w-6 h-6 text-primary-400" />
                        </div>
                        <h3 className="text-lg md:text-xl font-bold mb-2 relative z-10">Fale com nossos especialistas</h3>
                        <p className="text-gray-400 text-sm mb-5 flex-grow relative z-10 text-balance max-w-sm">
                        ...
                        <button 
                            ...
                            className="w-full sm:w-auto px-6 py-2.5 md:py-3 bg-primary-600 hover:bg-primary-500 text-white rounded-none font-bold text-sm md:text-base shadow-[0_0_15px_rgba(139,92,246,0.3)] transition-all flex items-center justify-center relative z-10 cursor-pointer"
                        >
                            Falar no WhatsApp
                    ...
                    >
                        ...
                        <h3 className="text-lg md:text-xl font-bold mb-2 relative z-10">Seja um Parceiro</h3>
                        <p className="text-gray-400 text-sm mb-5 flex-grow relative z-10 text-balance max-w-sm">
                        ...
                        <button 
                            ...
                            className="w-full sm:w-auto px-6 py-2.5 md:py-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-none font-semibold text-sm md:text-base transition-colors flex items-center justify-center cursor-pointer relative z-10"
                        >
                            Partner Program
                            <ArrowRight className="w-4 h-4 ml-2" />
                        </button>
